...
<p align="justify">У меня есть теоретическая база в области тестирования программного обеспечения и практический опыт как в ручном, так и в автоматизированном тестировании.<br> 
