...
### 👨‍💻 Обо мне:
<p align="justify">Я обладаю теоретической базой в области тестирования программного обеспечения и горю желанием развиваться в этой сфере. 
  -- Есть небольшой опыт в роли бета-тестировщика. Опыт работы оператором электронно-вычислительных машин десять лет. Обязанности на предыдущем месте работы:
